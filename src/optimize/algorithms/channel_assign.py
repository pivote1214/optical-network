...
from src.optimize.models.RSA_PATH_CHANNEL.make_input import calc_required_slots
from utils.network import select_modulation_format
...
def first_fit(
    ...
    for p_ind, path in enumerate(candidate_paths):
        path_length = calc_path_weight(optical_network.graph, path)
